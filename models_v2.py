...
def _load_sabian_symbols_json() -> dict:
    ...
    # Fallback to static_data if JSON doesn't exist
    from static_data import SABIAN_SYMBOLS
...
def _load_object_sign_combo_json() -> dict:
    ...
    # Fallback to static_data if JSON doesn't exist
    from static_data import OBJECT_SIGN_COMBO
...
def _load_object_house_combo_json() -> dict:
    ...
    # Fallback to static_data if JSON doesn't exist
    from static_data import OBJECT_HOUSE_COMBO
...
def migrate_lookup_data():
    ...
    for name, data in ASPECTS.items():
        ...
        static.aspects[name] = Aspect(
            ...
            aspect_type=data.get('aspect_type', 'Major'),
