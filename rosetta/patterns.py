        ...
        for j in range(i + 1, len(unnamed_sets)):
            ...
            if len(shared) == 2:  # exactly two shared nodes
                ...
                if len(combined) == 4:
                    ...
                    if (
                        aspect_match(a, b, "Square")
                        and aspect_match(a, c, "Trine")
                        and aspect_match(b, d, "Trine")
                        and aspect_match(c, d, "Square")
                        and aspect_match(a, d, "Quincunx")
                    ):
                        ...
                        suppresses = {
                            "suppress": {"Unnamed": {frozenset(u1), frozenset(u2)}}
                        }

                        add_special(
                            "Lightning Bolt", [a, b, c, d], candidate_edges, suppresses
                        )
